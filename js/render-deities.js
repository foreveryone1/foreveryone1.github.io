class RenderDeities{static $getRenderedDeity(a){return $$`
			...
			${Renderer.utils.getExcludedTr(a,"deity")}
			${Renderer.utils.getNameTr(a,{suffix:a.title?`, ${a.title.toTitleCase()}`:"",page:UrlUtil.PG_DEITIES})}
		...
		`}static _getDeityBody(a,b){const c=Renderer.get(),d=[];return a.entries&&c.recursiveRender({entries:a.entries},d),`
			...
			${a.symbolImg?`<tr><td colspan="6">${c.render({entries:[a.symbolImg]})}<div class="mb-2"/></td></tr>`:""}
